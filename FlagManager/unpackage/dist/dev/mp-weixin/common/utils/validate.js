...
function validateFlagForm(form) {
...
function validateCheckinForm(form, options = {}) {
...
function canFlagCheckin(flag) {
  return flag && flag.status === "active";
}
exports.canFlagCheckin = canFlagCheckin;
exports.validateCheckinForm = validateCheckinForm;
exports.validateFlagForm = validateFlagForm;
exports.validateStageForm = validateStageForm;
