...
const globalStyle = {
  ...
  navigationBarTitleText: "FlagManager",
...
var define_process_env_UNI_STAT_TITLE_JSON_default = { "pages/stats/stats": "统计", "pages/mine/mine": "我的", "pages/flag/create": "新建 Flag", "pages/flag/detail": "Flag 详情", "pages/flag/list": "我的 Flag", "pages/stage/create": "新建阶段", "pages/stage/detail": "阶段详情", "pages/checkin/create": "今日打卡" };
    ...
    }
    {
      ...
      if (!index.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index.__stat_uniCloud_space = _r.init(spaceData);
        } else {
